...
const events: ArchiveEvent[] = [
  {
    title: 'PROGEN 1기 — 클로드 AI 실전 클래스',
    date: '2026. 5. 16',
    location: '충남대학교 경상대학(E6)',
    participants: 80,
    desc: '"시간을 돌려받는" 클로드 AI 실전 클래스. 장학금·공모전·채용 정보 키워드 자동 알림 시스템을 직접 구축하고, 바이브 코딩으로 자기만의 어플까지 직접 만들어 봤습니다. 반복 작업에 쓰던 시간을 통째로 돌려받는 노하우를 그날 바로 가져갔습니다.',
    tags: ['바이브 코딩', '자동화', '노코드', '클로드 AI'],
    highlights: ['80명 참가', '대전 7개 대학교 참여', '키워드 자동 알림 구축'],
    photos: ['/archive/0516-1.jpg', '/archive/0516-2.jpg'],
  },
  {
    ...
    highlights: ['수업 녹음 → 시험 대비 자동화', '대전 7개 대학교 참여', '중간고사 즉시 적용'],
  ...
  },
  {
    ...
    highlights: ['80명 참가', '대전 7개 대학교 참여', '팀 실습 보고서 완성'],
