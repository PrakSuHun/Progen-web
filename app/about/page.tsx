      ...
      <div className="pt-20 md:pt-24">
        ...
        <section className="px-5 lg:px-8 py-16 md:py-24">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-black leading-tight mb-5">
              왜 PROGEN을<br />
              <span className="text-sky-500">만들었는가</span>
            </h1>
        ...
        <section className="px-5 lg:px-8 py-16 md:py-24 bg-[#fafafa]">
          <div className="max-w-7xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-black leading-tight mb-10">
              PROGEN의 <span className="text-sky-500">핵심 가치</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
              {values.map((v) => (
                <div key={v.num} className="p-5 md:p-7 bg-white border border-[#eee] rounded-2xl hover:border-sky-200 transition-colors">
                  <span className="inline-flex w-8 h-8 rounded-lg bg-sky-500 text-white font-black text-xs items-center justify-center mb-4">{v.num}</span>
            ...
            <div className="bg-sky-500 text-white rounded-2xl p-6 md:p-10">
              ...
              <blockquote className="text-xl md:text-2xl font-black leading-snug">
                ...
                AI 도구를 활용해 문제를 해결하는 &lsquo;단체&rsquo;입니다.&rdquo;
              </blockquote>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 lg:px-8 py-16 md:py-24">
          <div className="max-w-7xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-black leading-tight mb-10">
              <span className="text-sky-500">대표</span> 소개
            </h2>
            ...
            <div className="rounded-2xl bg-[#fafafa] border border-[#eee] p-5 md:p-10 mb-10">
              <div className="flex flex-col md:flex-row gap-6 md:gap-10">
                <div className="shrink-0 flex items-start gap-4 md:flex-col">
                  <div className="w-14 h-14 rounded-xl bg-sky-500 flex items-center justify-center text-xl font-black text-white">
                    박
                  </div>
                  <div>
                ...
                <div className="flex-1">
                  ...
                  <blockquote className="text-[#444] text-sm leading-[1.8]">
                    ...
                    결국 <span className="text-sky-600 font-semibold">&lsquo;실행력&rsquo;과 &lsquo;도구의 활용&rsquo;</span>이 생존의 핵심이라는 점이었습니다.
            ...
            {/* Stats */}
            <div className="bg-sky-500 text-white rounded-2xl overflow-hidden">
        ...
        <section className="px-5 lg:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-black text-black mb-4">
              함께 <span className="text-sky-500">시작</span>할 준비 되셨나요?
            </h2>
            <p className="text-[#666] text-base mb-8">무료 · 전공 무관 · 대전 소재 대학생 누구나</p>
            <Link href="/apply"
              className="inline-block px-8 py-4 bg-sky-500 text-white font-bold rounded-full text-base hover:bg-sky-600 transition-all shadow-lg shadow-sky-500/20">
              1기 크루 지원하기 →
            </Link>
          </div>
        </section>
