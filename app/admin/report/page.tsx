    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="print:hidden sticky top-0 bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between z-10">
        ...
        <div className="flex gap-2">
          <button onClick={() => window.print()} className="px-4 py-2 bg-violet-500 hover:bg-violet-600 text-white text-sm font-bold rounded-xl transition-colors">PDF 출력</button>
        </div>
      </div>
      ...
      <div className="max-w-[800px] mx-auto px-8 py-10 print:px-0 print:py-0">
        <style jsx global>{`
          ...
          .report-body h1 { font-size: 22px; font-weight: 800; border-bottom: 2px solid #7c3aed; padding-bottom: 8px; margin-top: 40px; margin-bottom: 16px; }
          .report-body h2 { font-size: 17px; font-weight: 700; color: #7c3aed; margin-top: 32px; margin-bottom: 12px; }
          ...
          .report-body th { background: #f1f5f9; border: 1px solid #e2e8f0; padding: 8px 12px; text-align: left; font-weight: 600; color: #7c3aed; }
          ...
          .report-body .highlight { background: #f5f3ff; border: 1px solid #ddd6fe; border-radius: 8px; padding: 16px; margin: 12px 0; }
