      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 md:mb-20">
          <h2 className="text-3xl md:text-5xl font-black text-black leading-tight mb-4">
            AI 시대를 생존하는<br />
            <span className="text-sky-500">가장 확실한 방법</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16 md:mb-24">
          {missions.map((m) => (
            <div key={m.num} className="p-5 md:p-7 rounded-2xl bg-[#fafafa] border border-[#eee] hover:border-sky-200 transition-colors">
              <span className="inline-block w-8 h-8 rounded-lg bg-sky-500 text-white font-black text-xs flex items-center justify-center mb-4">{m.num}</span>
        ...
        <div className="rounded-2xl bg-[#fafafa] border border-[#eee] p-5 md:p-10 mb-16 md:mb-24">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10">
            <div className="shrink-0 flex items-start gap-4 md:flex-col">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-sky-500 flex items-center justify-center text-lg md:text-xl font-black text-white">
                박
              </div>
              <div>
          ...
          <div className="space-y-3">
            {forWho.map((text, i) => (
              <div key={i} className="flex items-start gap-4 p-4 md:p-5 rounded-xl bg-[#fafafa] border border-[#eee]">
                <span className="w-7 h-7 rounded-lg bg-sky-100 text-sky-600 font-black text-xs flex items-center justify-center shrink-0 mt-0.5">
                  {i + 1}
                </span>
