  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <Reveal>
            ...
            <h2 className="text-2xl md:text-4xl font-black text-black leading-snug mb-6">
              크루가 되면<br className="md:hidden" /> <span className="text-sky-500">이런 혜택</span>이 있어요
            </h2>
          </Reveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {benefits.map((b, i) => (
              <Reveal key={b.title} delay={i * 70}>
                <div className="flex gap-4 p-4 md:p-5 bg-[#fafafa] border border-[#eee] rounded-2xl card-lift hover:border-sky-200 h-full">
                  <span className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-sky-500 text-white font-black text-xs md:text-sm flex items-center justify-center shrink-0">
      ...
      <section className="py-14 md:py-24 px-5 lg:px-8 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            ...
            <p className="text-sky-500 text-xl md:text-2xl font-black mb-3">원하는 만큼만, 자유롭게</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Reveal delay={0}>
              <div className="p-5 md:p-7 bg-white border border-[#eee] rounded-2xl card-lift h-full">
                <div className="w-9 h-9 rounded-xl bg-sky-100 text-sky-500 font-bold text-base flex items-center justify-center mb-3">✓</div>
      ...
      <section className="py-14 md:py-24 px-5 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <Reveal>
            <div className="bg-sky-500 text-white rounded-2xl p-5 md:p-10 text-center relative overflow-hidden">
