      ...
      <div className="max-w-7xl mx-auto">
        <Reveal>
          ...
          <h2 className="text-2xl md:text-4xl font-black text-black leading-snug mb-2">
            참가자 <span className="text-sky-500">생생 후기</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {reviews.map((r, i) => (
            <Reveal key={r.name} delay={i * 100}>
              <div className="p-4 md:p-7 bg-white border border-[#eee] rounded-2xl flex flex-col justify-between card-lift hover:border-sky-200 h-full">
                <div>
                  <div className="text-sky-400 text-xs tracking-wider mb-3">★ ★ ★ ★ ★</div>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-[#eee]">
                  <div className="w-8 h-8 rounded-full bg-sky-100 flex items-center justify-center text-[10px] font-black text-sky-600 shrink-0">{r.name[0]}</div>
                  <div>
