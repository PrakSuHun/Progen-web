...
- 처리: `POST /api/grape-feedback` → `grape_feedbacks`에 활성 행사(`getActiveEventId`) 연결 INSERT. 성공 시 감사 화면.
...
| POST | `/api/grape-feedback` | 포도용 기명 피드백 (`/grapefeedback` 폼). 이름+3문항 전부 필수, 활성 행사에 연결 INSERT. 2026-09-21 신설 |
